...
IC		void		begin			(const _index_type &vertex_id, typename inherited::const_iterator &begin, typename inherited::const_iterator &end);
IC		const _index_type get_value	(typename inherited::const_iterator &i) const;
};
