...
TEMPLATE_SPECIALIZATION
IC	void CLevelPathManager::begin			(const _index_type &vertex_id, typename inherited::const_iterator &begin, typename inherited::const_iterator &end)
{
	graph->begin			(best_node,begin,end);
}

TEMPLATE_SPECIALIZATION
IC	const _index_type CLevelPathManager::get_value		(typename inherited::const_iterator &i) const
{
